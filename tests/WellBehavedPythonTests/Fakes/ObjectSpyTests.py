...
class SampleObject:
    ...
    def _privateMethod(self):
        """A private method. This should not be replaced with a method spy."""

class ObjectSpyTests(TestCase):
    
    def test_spying_on_object(self):
        # Where
        object = SampleObject();
        ...
        # Then
        expect(spy).Not.toBeNone()
        expect(spy).toEqual(object);
