...
+ zzz""")
    ...
    def test_string_starts_with_prepends_userMessage_on_failure(self):
        data = 'asdf'
        expect(lambda: withUserMessage('userMessage').expect(data).toEndWith('eeeasdf')).toRaise(
            AssertionError,
            expectedMessageMatches = "^userMessage")
    ...
    def test_string_contains_prepends_userMessage(self):
        actual = 'asdf'
        expect(lambda: withUserMessage('userMessage').expect(actual).toContain('zzz')).toRaise(
            AssertionError,
            expectedMessageMatches = '^userMessage')
...
+ world""")
    ...
    def test_string_equals_prepends_userMessage_on_failure(self):
        expect(lambda: withUserMessage('userMessage').expect('hello').toEqual('world')).toRaise(
            AssertionError,
            expectedMessageMatches = "^userMessage")
    ...
    def test_expect_string_to_match_prepends_userMessage_on_failure(self):
        actual = 'asdf'
        pattern = re.compile('^[^asdf]+$')
        expect(lambda: withUserMessage('userMessage').expect(actual).toMatch(pattern)).toRaise(
            AssertionError,
            expectedMessageMatches = '^userMessage')                    
...
class StringNotExpectationsTests(TestCase):
    ...
    def test_string_not_contains_prepends_userMessage(self):
        actual = 'asdf'
        expect(lambda: withUserMessage('userMessage').expect(actual).Not.toContain('sd')).toRaise(
            AssertionError,
            expectedMessageMatches = '^userMessage')
    ...
    def test_string_not_equals_prepends_userMessage_on_failure(self):
        actual = 'asdf'
        expect(lambda: withUserMessage('userMessage').expect(actual).Not.toEqual('asdf')).toRaise(
            AssertionError,
            expectedMessageMatches = '^userMessage')
    ...
    def test_string_not_matches_prepends_userMessage_on_failure(self):
        actual = 'asdf'
        pattern = 'asdf'
        expect(lambda: withUserMessage('userMessage').expect(actual).Not.toMatch(pattern)).toRaise(
            AssertionError,
            expectedMessageMatches = '^userMessage')
